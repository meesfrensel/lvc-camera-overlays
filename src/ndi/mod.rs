    ...
    pub fn from_buffer(
        ...
        Self {
            ...
            p_instance: NDIlib_video_frame_v2_t {
                ...
                p_metadata: metadata.map(|m| m.as_ptr()).unwrap_or(null()),
...
/// you slightly better performance in some cases. In general it is more
/// "correct" to call this although it is not required.
///
